  ...
  return <section className="border-y border-white/10 bg-[#0b0b0a]">
    <Container className="grid grid-cols-2 items-center gap-16 py-20 max-lg:gap-8 max-md:grid-cols-1">
      <div>
        ...
        <p className="section-copy max-w-[450px] max-sm:hidden">A sky designed for your car. Shape the pattern, color and movement around the atmosphere you want inside your vehicle.</p>
